...
/**
 * Parser for {@link NacosA2aTransportProperties} from Environment.
 *
 * <p>
...
public class NacosA2aTransportPropertiesEnvParser {
    ...
    public NacosA2aTransportPropertiesEnvParser() {
     ...
     * {@link NacosA2aTransportProperties}.
     *
     * <p>
     ...
     */
    public Map<String, NacosA2aTransportProperties> getTransportProperties() {
        ...
        Map<String, NacosA2aTransportProperties> result = new HashMap<>(transportProperties.size());
        transportProperties.forEach((transport, properties) -> {
            result.put(transport, mapper.convertValue(properties, NacosA2aTransportProperties.class));
        });
        return result;
    }
